...
export function EmotionSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#010101] px-5 py-24 sm:px-6 lg:px-8" aria-labelledby="emotion-title">
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2 lg:items-center">
        <motion.div
          className="relative min-h-[520px] overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.09),rgba(255,255,255,0.02))] backdrop-blur-xl"
        ...
        >
          ...
          <div className="relative flex h-full min-h-[520px] items-end justify-start p-6 sm:p-8">
            <motion.div
        ...
        >
          ...
          <div className="mt-7 space-y-5 text-base leading-8 text-white/64 sm:text-lg">
            <p>{t.emotion.paragraph1}</p>
            <p>{t.emotion.paragraph2}</p>
          </div>
          <a
            href="#details"
            className="focus-ring mt-9 inline-flex items-center gap-3 rounded-full border border-white/15 bg-white/[0.04] px-6 py-4 text-sm font-semibold text-white transition hover:border-[#FA93FA]/50 hover:bg-white/[0.08]"
          >
            {t.emotion.cta}
