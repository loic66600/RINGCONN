...
export function ComparisonSection() {
  ...
  return (
    <section className="relative bg-[#010101] px-5 py-14 sm:px-6 sm:py-20 lg:px-8 lg:py-24" aria-labelledby="comparison-title">
      <div className="mx-auto max-w-7xl">
        ...
        <motion.div
          className="glass-panel mt-8 overflow-hidden rounded-[1.5rem] sm:mt-14 sm:rounded-[2rem]"
        ...
        >
          <div className="grid grid-cols-[1.2fr_0.9fr_0.9fr] border-b border-white/10 bg-white/[0.03] text-sm font-semibold text-white sm:text-base">
            <div className="p-3 sm:p-6">{t.comparison.benefit}</div>
            <div className="flex items-center gap-2 border-l border-white/10 p-3 sm:p-6">
              <Smartphone className="h-4 w-4 text-[#FA93FA]" />
              {t.comparison.ring}
            </div>
            <div className="flex items-center gap-2 border-l border-white/10 p-3 text-white/60 sm:p-6">
          ...
          {t.comparison.rows.map((label, index) => {
            ...
            return (
              ...
              <div className="p-3 text-sm text-white/70 sm:p-6 sm:text-base">{label}</div>
              <div className="grid place-items-center border-l border-white/10 p-3 sm:p-6">
                {ring ? (
